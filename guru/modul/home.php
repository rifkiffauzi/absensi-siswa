					...
					<div class="page-inner py-5">
						<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
							<div>
								...
								<h5 class="text-white op-7 mb-2">Selamat Datang, <b class="text-warning"><?=$data['nama_guru']; ?></b></b> | Aplikasi Absensi Siswa</h5>
							</div>
...
Bogor Timur 16720
	<br>Telepon : 0251-8242411  /  082221718035
(Whatsapp)
										</center>
									</div>
									...
									<div class="tab-content mt-2 mb-3" id="pills-with-icon-tabContent">
										...
										<div class="tab-pane fade" id="pills-contact-icon" role="tabpanel" aria-labelledby="pills-contact-tab-icon">
											<p>
												...
												Aplikasi Presensi siswa ini dibuat untuk mendokumentasikan kehadiran siswa, Aplikasi sangat Mudah digunakan (Berbasis Web)
											</p>
										</div>
									</div>
								</div>
